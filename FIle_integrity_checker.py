import hashlib # we are importing the hashlib library to calculate the hash of the files
import os # we are importing the os library to work with the file system
import json # we are importing the json library to save and load the hash records in a json file
...
def main():
    ...
    print("=" * 50)
    # we are asking the user to enter the folder path that they want to scan or check the integrity of the files
    folder_path = input("Enter the folder path: ").strip()
    if not os.path.exists(folder_path):
        print("[error] folder path does not exist")
        return
    # we are asking the user to choose between scanning the folder and checking the integrity of the files
...
if __name__ == "__main__":    
    # we are calling the main function to run the program
    main()
